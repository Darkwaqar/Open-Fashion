  ...
  return (
    <View>
      <View style={tw`bg-white items-center gap-y-5 my-5`}>
        ...
        <Divider />
        <Text style={{ fontFamily: 'TenorSans', fontSize: 16 }}>support@openui.design</Text>
        <Text style={{ fontFamily: 'TenorSans', fontSize: 16 }}> +60 825 876</Text>
        <Text style={{ fontFamily: 'TenorSans', fontSize: 16 }}>08:00 - 22:00 - Everyday</Text>
        <Divider />
        <View style={tw`flex-row justify-around w-[162px] gap-x-30`}>
          <Text style={{ fontFamily: 'TenorSans', fontSize: 16, lineHeight: 24 }}>About</Text>
          <Text style={{ fontFamily: 'TenorSans', fontSize: 16, lineHeight: 24 }}>Contact</Text>
          <Text style={{ fontFamily: 'TenorSans', fontSize: 16, lineHeight: 24 }}>Blog</Text>
        </View>
      </View>
